    ...
    <div className="relative">
      <Container>
            ...
            <div>
              ...
              <Link href="/">
                <a className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                  ...
                  <span>Muziriz Technologies</span>
                </a>
              </Link>
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
              Modernize your infrastructure & legacy applications leveraging
              Kubernetes, containers, & other cloud native capabilities with
              Searce.
            </div>
        ...
        <div className="my-10 text-sm text-center text-gray-600 dark:text-gray-400">
          ...
          <a href="https://intelltech.in/" target="_blank" rel="noopener">
            Intelltech Team
          </a>
        </div>
      </Container>
